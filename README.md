...
It is what allows us to write/use middleware with Node.js (described in the next answer). It also gives us access to .Router(), which allows us to avoid an overly complicated index.js file.
